...
@export_range(0.0, 200.0) var _GENERAL_SPEED_MULTIPLIER: float = 100.0
...
func _physics_process(delta) -> void: 
	...
	# move human
	position.x += pow(-1, int(human_sprite.flip_h)) * delta * _GENERAL_SPEED_MULTIPLIER * human_moving_speed
